...
def parse_args():
    ...
    parser.add_argument('--config', default='/media/lance/NewPlant/Users/Lance/Desktop/FD/ZSFD/Desktop/RRFS-main-ori/mmdetection/configs/faster_rcnn_r101_fpn_1xuec.py', help='train config file path')
    parser.add_argument('--classes', default='seen', help='seen or unseen classes')
    parser.add_argument('--load_from', default='/media/lance/NewPlant/Users/Lance/Desktop/FD/ZSFD/Desktop/RRFS-main-ori/mmdetection/tools/work_dirs/uecfood256/epoch_12.pth', help='the checkpoint file to load from')
    parser.add_argument('--save_dir', default='/media/lance/NewPlant/Users/Lance/Desktop/FD/ZSFD/Desktop/RRFS-main-ori/data/uec256/', help='the dir to save feats and labels')
