...
def single_gpu_test(model, data_loader, show=False):
    ...
    for i, data in enumerate(data_loader):
        ...
        if show:
            model.module.show_result(data, result, out_file='temp.jpg')
            input()
...
def parse_args():
    ...
    parser.add_argument('--config',
                        default='/media/lance/NewPlant/Users/Lance/Desktop/FD/ZSFD/Desktop/RRFS-main-ori/mmdetection/configs/faster_rcnn_r101_fpn_1xuec.py',
    ...
    parser.add_argument('--syn_weights', default='/media/lance/NewPlant/Users/Lance/Desktop/FD/ZSFD/Desktop/RRFS-main-ori/checkpoints_try/classifier_best.pth',
                        help='the dir to save logs and models')

    parser.add_argument('--out', default='voc_results.pkl', help='output result file')

    parser.add_argument('--alpha1', default=0.3, help='tradeoff for background features')
    ...
    parser.add_argument('--dataset', default='uec256', help='coco, voc, imagenet')
    parser.add_argument(
        '--json_out',
...
def main():
    ...
    cfg.test_cfg.rcnn.score_thr = 5e-2
    ...
    if args.syn_weights:
        seen_bg_weight, seen_bg_bias = copy_synthesised_weights(model, args.syn_weights, args.alpha1, dataset_name, split=cfg.data.test.split)
