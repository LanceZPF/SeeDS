...
class MLPDiffusion(nn.Module):
    def  __init__(self, d_in=1024, num_classes=20, is_y_cond=False, rtdl_params={}, dim_t=128, dim_att=300):
        super().__init__()
        self.dim_t = dim_t
        ...
        rtdl_params['d_layers'] = [256,256]
        rtdl_params['dropout'] = 0.0
        ...
        self.label_emb = nn.Linear(dim_att, dim_t)
